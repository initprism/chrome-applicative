...
pub mod events {
    ...
    #[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
    #[serde(rename_all = "camelCase")]
    pub struct CorsErrorStatusParams {
        pub cors_error: String,
    ...
    pub struct LoadingFailedEventParams {
        ...
        pub cors_error_status: Option<CorsErrorStatusParams>,
    }
...
pub mod methods {
    ...
    pub struct EmulateNetworkConditions {
        pub offline: bool,
        pub latency: JsInt,
        pub download_throughput: JsInt,
        pub upload_throughput: JsInt,
        pub connection_type: Option<ConnectionType>,
    }

    impl<'a> Method for EmulateNetworkConditions {
